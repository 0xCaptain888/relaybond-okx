...
| 2026-09-17 16:05 UTC+8 | pending commit | Fail-closed missing-evidence readiness: `settlement:v2:plan` now returns structured `ready: false` output instead of a filesystem exception and never broadcasts | CLI rehearsal with LIVE Evidence Pack absent | LOCAL / TESTED |
